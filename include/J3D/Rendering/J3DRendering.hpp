...
namespace J3DRendering {
    ...
    void Render(float deltaTime, glm::vec3 cameraPosition, glm::mat4& viewMatrix, glm::mat4& projMatrix,
                                 RenderFunctionArgs modelInstances, uint32_t materialShaderOverride = 0);
}