...
class J3DMaterial;
struct J3DMaterialBlockV3;

struct J3DMaterialInitDataV3 {
	uint8_t PEMode;
	uint8_t CullMode;
...
class J3DMaterialFactoryV3 {
	J3DMaterialBlockV3* mBlock;
...
public:
	J3DMaterialFactoryV3(J3DMaterialBlockV3* srcBlock, bStream::CStream* stream);
	~J3DMaterialFactoryV3() {}
